...
class Validations {
  ...
  RegExp expressionForOnlyLetter = RegExp(r"[^a-z\s]", caseSensitive: false);
  ...
  static String? firstName(String? value) {
    ...
    // check if the name only contain letters
        ...
        .expressionForOnlyLetter
        .allMatches(value)
        .isNotEmpty) {
      return 'Only letters are allowed';
    } else if (value.length < 4) {
      return 'Must be 4 or more characters';
    }

    return null;
  }

  static String? fullNameValidation(value) {
  ...
  static String? passwordConfirmation(String? value) {
    if (value == null || value == '') {
      ...
      return 'Password must contain at least one number';
    } else if (!stringContainsLowerCase(value)) {
  ...
  static String? codeVerification(code) {
    if (code == '') {
    ...
    } else if (!Validations().expressionForOnlyNumbers.hasMatch(code!)) {
      return 'Only numbers are allowed';
    }
    return null;
  }
